    ...
    public function loadPostsConnections($data, $limit){
        ...
        while($row = mysqli_fetch_array($data_query)){
            ...
            if($row['user_to'] == "none"){
                ...
                $user_to = " to <a style='font-weight:bold;text-decoration:none;color:#800020' href='" . $row['user_to'] ."'>" . $user_to_name . "</a>";
            }
            ...
            $str .= "<div class ='status-post' onClick='javascript:toggle$id()'>
                        ...
                        <div class ='posted_by' style='color:black;'>
                            <a href='$added_by' style='color:#800020; font-weight:bold'> $first_name $last_name </a> $user_to 
                           $delete_button <br>
    ...
    public function loadProfilePosts($data, $limit){
        ...
        while($row = mysqli_fetch_array($data_query)){
            ...
            $str .= "<div class ='status-post' onClick='javascript:toggle$id()'>
                        ...
                        <div class ='posted_by' style='color:black;'>
                            <a href='$added_by' style='color:#800020; font-weight:bold'> $first_name $last_name </a> 
                           $delete_button <br>
                            <p class='post-timestamp'>$time_message<p>
                        </div>
                        <div id='post_body'>
